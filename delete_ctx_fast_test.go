...
func TestDeleteBuilderFastContextRunners(t *testing.T) {
	db := &DBStub{}
...
func TestDeleteBuilderFastContextNoRunner(t *testing.T) {
	b := DeleteFast("test").Where("x != ?", 0).Suffix("RETURNING x")
