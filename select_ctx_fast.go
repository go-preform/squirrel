...
func (d *SelectBuilderFast) ExecContext(ctx context.Context) (sql.Result, error) {
	if d.runWith == nil {
...
func (d *SelectBuilderFast) QueryContext(ctx context.Context) (*sql.Rows, error) {
	if d.runWith == nil {
		return nil, RunnerNotSet
	}
...
func (d *SelectBuilderFast) QueryRowContext(ctx context.Context) RowScanner {
	if d.runWith == nil {
...
func (b SelectBuilderFast) ScanContext(ctx context.Context, dest ...interface{}) error {
