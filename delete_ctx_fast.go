...
func (d DeleteBuilderFast) ExecContext(ctx context.Context) (sql.Result, error) {
	if d.runWith == nil {
...
func (d DeleteBuilderFast) QueryContext(ctx context.Context) (*sql.Rows, error) {
	if d.runWith == nil {
		return nil, RunnerNotSet
	}
...
func (d DeleteBuilderFast) QueryRowContext(ctx context.Context) RowScanner {
	if d.runWith == nil {
...
func (b DeleteBuilderFast) ScanContext(ctx context.Context, dest ...interface{}) error {
